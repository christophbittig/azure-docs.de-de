...
## <a name="create-a-linked-service-to-teradata-using-ui"></a>Erstellen eines verknüpften Diensts für Teradata über die Benutzeroberfläche
...
2. Suchen Sie nach Teradata, und wählen Sie den Teradata-Connector aus.
    ...
    :::image type="content" source="media/connector-teradata/teradata-connector.png" alt-text="Wählen Sie den Teradata-Connector aus.":::    

1. Konfigurieren Sie die Dienstdetails, testen Sie die Verbindung, und erstellen Sie den neuen verknüpften Dienst.

    :::image type="content" source="media/connector-teradata/configure-teradata-linked-service.png" alt-text="Konfigurieren Sie einen verknüpften Dienst für Teradata.":::
