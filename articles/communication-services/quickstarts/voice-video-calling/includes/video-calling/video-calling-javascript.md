...
## <a name="acs-calling-web-sdk-object-model"></a>Objektmodell des ACS Calling Web SDK
...
```
Öffnen Sie Ihren Browser, und navigieren Sie auf zwei Registerkarten zu http://localhost:8080/. Folgendes sollte angezeigt werden: :::image type="content" source="../../media/javascript/1-on-1-video-calling-a.png" alt-text="Seite mit 1:1-Videoanruf – a":::

Geben Sie auf der ersten Registerkarte ein gültiges Benutzerzugriffstoken und auf der anderen Registerkarte ein anderes gültiges Benutzerzugriffstoken ein. (Weitere Informationen finden Sie in der [Dokumentation zum Benutzerzugriffstoken](../../../access-tokens.md), wenn noch keine Token zur Verwendung verfügbar sind.)
Klicken Sie auf beiden Registerkarten auf die Schaltflächen „Initialize Call Agent“ (Anruf-Agent initialisieren). Folgendes sollte angezeigt werden: :::image type="content" source="../../media/javascript/1-on-1-video-calling-b.png" alt-text="Seite mit 1:1-Videoanruf – b":::

Geben Sie auf der ersten Registerkarte die ACS-Benutzeridentität der zweiten Registerkarte ein, und klicken Sie auf die Schaltfläche „Start Call“ (Anruf starten). Die erste Registerkarte startet den ausgehenden Anruf der zweiten Registerkarte, und auf der zweiten Registerkarte wird die Schaltfläche „Accept Call“ (Anruf annehmen) aktiviert: :::image type="content" source="../../media/javascript/1-on-1-video-calling-c.png" alt-text="Seite mit 1:1-Videoanruf – c":::

Klicken Sie auf der zweiten Registerkarte auf die Schaltfläche „Accept Call“ (Anruf annehmen), und der Anruf wird angenommen und die Verbindung hergestellt. Folgendes sollte angezeigt werden: :::image type="content" source="../../media/javascript/1-on-1-video-calling-d.png" alt-text="Seite mit 1:1-Videoanruf – d":::

Beide Registerkarten nehmen nun an einem 1:1-Videoanruf teil. Beide Registerkarten können die Audioausgabe des jeweils anderen hören und den Videostream sehen.
