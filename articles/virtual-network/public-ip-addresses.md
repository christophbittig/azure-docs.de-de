...
- Sie wurden in Übereinstimmung mit dem Modell „standardmäßig sicher“ konzipiert und sind bei Verwendung als Front-End für eingehenden Datenverkehr gesperrt.  Datenverkehr auf Datenebene mit einer [Netzwerksicherheitsgruppe](./network-security-groups-overview.md#network-security-groups) (NSG) muss auf die Positivliste gesetzt werden (z. B. auf der NIC eines virtuellen Computers mit angefügter öffentlicher IP-Adresse der Standard-SKU).
