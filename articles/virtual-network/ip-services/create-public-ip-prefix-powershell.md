---
title: 'Schnellstart: Erstellen eines Präfixes für öffentliche IP-Adressen – PowerShell'
...
ms.locfileid: "129369652"
---
# <a name="quickstart-create-a-public-ip-address-prefix-using-powershell"></a>Schnellstart: Erstellen eines Präfixes für öffentliche IP-Adressen mithilfe von PowerShell
...
Erstellen Sie mit [New-AzResourceGroup](/powershell/module/az.resources/new-azresourcegroup) eine Ressourcengruppe namens **QuickStartCreateIPPrefix-rg** am Standort **eastus2**.
...
Um eine öffentliche IPv6-IP-Adressen zu erstellen, geben Sie **IPv6** in den Parameter **`-IpAddressVersion`** ein.
```azurepowershell-interactive
$pf =@{
    Name = 'myPublicIpPrefix'
    ResourceGroupName = 'QuickStartCreateIPPrefix-rg'
...
Im nächsten Artikel erfahren Sie, wie Sie ein Präfix für öffentliche IP-Adressen mithilfe der Azure-Befehlszeilenschnittstelle erstellen:
> [!div class="nextstepaction"]
> [Erstellen eines Präfixes für öffentliche IP-Adressen mithilfe von PowerShell](create-public-ip-powershell.md)
