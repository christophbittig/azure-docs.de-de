...
|---|---|---|---|---|---|---|
| [Ja](#register) | [Ja](#scan)|[Ja](#scan) | [Ja](#scan)|[Ja](#scan)| Ja | [Data Factory-Datenherkunft](how-to-link-azure-data-factory.md) |
...
1. **Öffnen Sie Purview Studio** und navigieren Sie zu **Data Map --> Quellen**
    ...
    :::image type="content" source="media/register-scan-adls-gen2/register-adls-gen2-sources.png" alt-text="Screenshot: Navigieren zum Quellen-Link in der Data Map":::
