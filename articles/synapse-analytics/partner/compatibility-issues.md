...
* [T-SQL-Sprachelemente für dedizierten SQL-Pool in Azure Synapse Analytics.](../sql-data-warehouse/sql-data-warehouse-reference-tsql-language-elements.md)
* [T-SQL-Anweisungen, die vom dedizierten SQL-Pool in Azure Synapse Analytics unterstützt werden.](../sql-data-warehouse/sql-data-warehouse-reference-tsql-statements.md)