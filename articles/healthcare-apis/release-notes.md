...
|------------- | -----------------------------: |
|Tool zum Testen des Datengenerators |Wir haben das Repository mit den GitHub-APIs für das Gesundheitswesen aktualisiert, um ein Tool für den [Testdatengenerator](https://github.com/microsoft/healthcare-apis-samples/blob/main/docs/HowToRunPerformanceTest.md) mit Synthea-Daten einzuarbeiten. Dieses Tool ist eine Verbesserung [](https://github.com/ShadowPic/PublicTestProjects)der öffentlichen Open Source-Testprojekte, die auf Apache JMeter basieren und für Leistungstests in Azure AKS bereitgestellt werden können. |
...
|------------------------ | -------------------------------: |
|Regions |"Brasilien, Süden" und "Kanada, Mitte" |
...
|Neue Untertypen des [Überwachungsereignis OperationName wurden hinzugefügt.](./././azure-api-for-fhir/enable-diagnostic-logging.md#audit-log-details) | [#2170](https://github.com/microsoft/fhir-server/pull/2170) |
...
|------------------------ | -------------------------------: |
|Breiterer Catch für Ausnahmen beim Anwenden des Patches. | [#2192](https://github.com/microsoft/fhir-server/pull/2192)|
|Korrigiert den Verlauf mit PATCH in HOTFIX3. |[#2177](https://github.com/microsoft/fhir-server/pull/2177) |
...
|Legen Sie die maximale Elementanzahl in den Suchoptionen in SearchParameterDefinitionManager fest. |[#2141](https://github.com/microsoft/fhir-server/pull/2141) |
|Bietet eine bessere Ausnahme, wenn ein Suchparameter einen fehlerhaften Ausdruck enthält. |[#2157](https://github.com/microsoft/fhir-server/pull/2157) |
...
|Behebung von Programmfehlern | Verwandte Informationen |
|------------------------ | -------------------------------: |
|Der IoT-Connector normalisierte Verbesserungen mit Berechnungen, um die Standardisierung von Integritätsdaten zu unterstützen und zu verbessern. | Siehe: [Verwenden von Gerätezuordnungen](./../healthcare-apis/iot/how-to-use-device-mapping-iot.md) und [berechneten Funktionen](https://github.com/microsoft/iomt-fhir/blob/master/docs/Configuration.md) |
