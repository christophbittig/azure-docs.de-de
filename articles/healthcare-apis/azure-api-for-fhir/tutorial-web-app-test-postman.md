...
ms.locfileid: "121784670"
---
# <a name="testing-the-fhir-api-on-azure-api-for-fhir"></a>Testen der FHIR-API auf Azure API for FHIR
...
* [Azure AD und Azure API for FHIR](azure-active-directory-identity-configuration.md): In diesem Dokument werden einige der grundlegenden Prinzipien von Azure Active Directory und dessen Interaktion mit Azure API for FHIR beschrieben.
* [Überprüfung von Zugriffstoken](azure-api-fhir-access-token-validation.md): Diese Schrittanleitung enthält genauere Informationen zur Überprüfung von Zugriffstoken sowie Schritte zur Behebung von Zugriffsproblemen.
