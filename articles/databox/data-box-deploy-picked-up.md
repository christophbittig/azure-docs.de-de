...
1. Planen Sie die Abholung durch UPS, falls Sie das Gerät zurücksenden. So planen Sie die Abholung:
    ...
    **Beim Versand aus Deutschland oder der Schweiz** können Sie auch den [selbst verwalteten Versand](data-box-deploy-picked-up.md#self-managed-shipping) nutzen.
