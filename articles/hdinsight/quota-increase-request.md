...
Sie können [sich an den Support wenden, um eine Erhöhung von Kernkontingenten anzufordern](../azure-portal/supportability/regional-quota-requests.md).
