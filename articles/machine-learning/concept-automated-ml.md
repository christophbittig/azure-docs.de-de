...
## <a name="when-to-use-automl-classification-regression--forecasting"></a>Anwendungsfälle für automatisiertes maschinelles Lernen: Klassifizierung, Regression und Vorhersage
