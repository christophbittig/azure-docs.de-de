...
ms.locfileid: "112580528"
---
# <a name="migrate-to-azure-machine-learning"></a>Migrieren zu Azure Machine Learning 

In diesem Artikel erfahren Sie, wie Sie Ressourcen aus Machine Learning Studio (Classic) zu [Azure Machine Learning](../index.yml) migrieren. Zu diesem Zeitpunkt müssen Sie Ihre Experimente zum Migrieren von Ressourcen manuell neu erstellen.
...
> * Schritt 5: Bereinigen von Ressourcen in Machine Learning Studio (Classic)
