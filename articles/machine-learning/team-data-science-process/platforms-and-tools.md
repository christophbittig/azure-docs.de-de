...
- Data Science-VMs (Windows und Linux Ubuntu)
...
Azure Machine Learning ist die empfehlenswerteste Plattform für die Data Science-Entwicklung.  Diese PaaS (Platform as a Service) kann eigenständig ausgeführt oder in andere, auf dieser Webseite erwähnte Plattformen und Tools integriert werden. Bei [Azure Machine Learning](../overview-what-is-azure-ml.md) (AzureML) handelt es sich um eine End-to-End-Plattform, die Folgendes umfasst:
...
Die Data Science-VM wird von Microsoft sowohl für Windows als auch für Linux angeboten und enthält beliebte Tools für Data Science-Modelle und Entwicklungsaktivitäten. 
...
In Data Science Virtual Machine sind die nützlichsten Data Science-Tools vorinstalliert.  Eine aktuelle Liste der Tools und Versionen finden Sie unter [In Data Science Virtual Machine enthaltene Tools](/azure/machine-learning/data-science-virtual-machine/tools-included).

Die Data Science-VM ist derzeit für die Betriebssysteme **Windows** und **Linux Ubuntu** verfügbar. Wählen Sie die Größe Ihrer Data Science-VM (Anzahl von CPU-Kernen und Größe des Arbeitsspeichers) abhängig von den Anforderungen der Data Science-Projekte aus, die Sie damit ausführen möchten. 
...
Wenn Sie den TDSP unter **Windows** verwenden möchten, müssen Sie für die Kommunikation mit den Git-Repositorys **Git Credential Manager (GCM)** installieren. Damit Sie GCM installieren können, müssen Sie zunächst **Chocolatey** installieren. Führen Sie zum Installieren von Chocolatey und GCM in Windows PowerShell die folgenden Befehle als **Administrator** aus:  
