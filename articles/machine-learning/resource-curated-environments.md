...
> [!NOTE]
> Diese Liste wurde im September 2021 aktualisiert. Verwenden Sie das [Python SDK](how-to-use-environments.md), die [CLI](/cli/azure/ml/environment?view=azure-cli-latest&preserve-view=true#az_ml_environment_list) oder Azure Machine Learning [Studio](how-to-manage-environments-in-studio.md), um die neueste Liste der Umgebungen und ihre Abhängigkeiten abrufen. Weitere Informationen finden Sie im [Artikel zu Umgebungen](how-to-use-environments.md#use-a-curated-environment). 
