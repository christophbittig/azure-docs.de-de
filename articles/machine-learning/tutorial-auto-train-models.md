...
Entfernen Sie einige der Spalten, die Sie für das Training und die Erstellung zusätzlicher Features nicht benötigen.  Beim Automatisieren von maschinellem Lernen werden automatisch zeitbasierte Features wie **lpepPickupDatetime** verarbeitet.
