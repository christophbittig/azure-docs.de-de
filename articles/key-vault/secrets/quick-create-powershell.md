...
Verwenden Sie das Azure PowerShell-Cmdlet [Set-AzKeyVaultAccessPolicy](/powershell/module/az.keyvault/set-azkeyvaultaccesspolicy), um die Key Vault-Zugriffsrichtlinie zu aktualisieren und Ihrem Benutzerkonto Berechtigungen für Geheimnisse zu gewähren.
...
Verwenden Sie das Azure PowerShell-Cmdlet [Get-AzKeyVaultSecret](/powershell/module/az.keyvault/get-azkeyvaultsecret), um den im Geheimnis enthaltenen Wert als Nur-Text anzuzeigen:
