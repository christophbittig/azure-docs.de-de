...
- Informationen zur Verwendung von Azure Sentinel finden Sie im [Schnellstart: Erste Schritte mit Azure Sentinel](/azure/defender-for-iot/organizations/articles/sentinel/get-visibility.md).