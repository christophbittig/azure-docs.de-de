...
* Weitere Informationen zur Arbeit mit dem aktuellen Release finden Sie unter [Schnellstart: Erste Schritte mit einem Beispielszenario in Azure Digital Twins-Explorer](quickstart-azure-digital-twins-explorer.md).

* Stattdessen können Sie sich zunächst auch unter [Benutzerdefinierte Modelle](concepts-models.md) mit den wichtigsten Konzepten vertraut machen.