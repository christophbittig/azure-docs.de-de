---
title: Azure Communication Services – Chatereignisse
description: In diesem Artikel wird beschrieben, wie Azure Communication Services als Event Grid-Ereignisquelle für Chatereignisse verwendet wird.
ms.topic: conceptual
ms.date: 10/15/2021
ms.author: vikramdh
...
ms.locfileid: "130134299"
---
# <a name="azure-communication-services---chat-events"></a>Azure Communication Services – Chatereignisse

In diesem Artikel werden die Eigenschaften und das Schema für Chatereignisse von Communication Services beschrieben.  Eine Einführung in Ereignisschemas finden Sie unter [Azure Event Grid-Ereignisschema](event-schema.md).

## <a name="event-types"></a>Ereignistypen

Von Azure Communication Services werden folgende Chatereignistypen ausgegeben:
