---
title: 'Azure PowerShell: Sichere WebHook-Zustellung mit Azure AD-Anwendung in Azure Event Grid'
description: Hier wird beschrieben, wie Ereignisse mittels Azure Event Grid an HTTPS-Endpunkte zugestellt werden, die durch eine Azure AD-Anwendung geschützt werden.
...
ms.locfileid: "130066583"
---
# <a name="secure-webhook-delivery-with-azure-ad-application-in-azure-event-grid"></a>Sichere WebHook-Zustellung mit Azure AD-Anwendung in Azure Event Grid

Dieses Skript enthält die erforderliche Konfiguration, um Ereignisse mittels Azure Event Grid an HTTPS-Endpunkte zuzustellen, die durch eine Azure AD-Anwendung geschützt werden.
...
1. Erstellen eines Dienstprinzipals für die **App für den Ereignisabonnementwriter**, wenn er nicht bereits vorhanden ist
1. Hinzufügen des Dienstprinzipals der Azure AD-App für den Ereignisabonnementwriter zur Rolle „AzureEventGridSecureWebhookSubscriber“ 
1. Hinzufügen des Dienstprinzipals „Microsoft.EventGrid“ zur Rolle „AzureEventGridSecureWebhookSubscriber“
