...
> [!NOTE]
> (Basic oder Standard) Passthrough-Liveereignisse werden NICHT automatisch heruntergefahren und müssen explizit über die API gestoppt werden, um eine übermäßige Abrechnung zu vermeiden.
