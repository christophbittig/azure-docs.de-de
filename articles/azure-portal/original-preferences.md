---
title: Verwalten von Einstellungen und Voreinstellungen im Azure-Portal (ältere Version)
description: Sie können die Standardeinstellungen des Azure-Portals ändern, um sie an Ihre eigenen Vorlieben anzupassen. In diesem Dokument wird die ältere Version der Benutzeroberfläche für Einstellungen beschrieben.
ms.date: 06/17/2021
ms.topic: how-to
...
ms.locfileid: "112372191"
---
# <a name="manage-azure-portal-settings-and-preferences-older-version"></a>Verwalten von Einstellungen und Voreinstellungen im Azure-Portal (ältere Version)

Sie können die Standardeinstellungen des Azure-Portals ändern, um sie an Ihre eigenen Vorlieben anzupassen. 

> [!IMPORTANT]
> Derzeit werden alle Azure-Benutzer zu einer neueren Benutzeroberfläche migriert. In diesem Thema wird die ältere Benutzeroberfläche beschrieben. Aktuelle Informationen finden Sie unter [Verwalten von Einstellungen und Voreinstellungen im Azure-Portal](set-preferences.md).

Die meisten Einstellungen stehen im Menü **Einstellungen** in der globalen Kopfzeile zur Verfügung.

![Screenshot, der globale Kopfzeilensymbole mit hervorgehobenen Einstellungen zeigt](./media/original-preferences/header-settings.png)
...
:::image type="content" source="media/original-preferences/filter-subscription-default-view.png" alt-text="Filtern Sie die Ressourcenliste nach dem Abonnement.":::
...
1. Wählen Sie die Abonnements aus, die beim Starten des Portals als Standardabonnements ausgewählt werden sollen. 
    ...
    :::image type="content" source="media/original-preferences/default-directory-subscription-filter.png" alt-text="Wählen Sie die Abonnements aus, die beim Starten des Portals als Standardabonnements ausgewählt werden sollen."::: 
...
![Screenshot mit Azure-Portaleinstellungen mit hervorgehobener Standardansicht](./media/original-preferences/default-view.png)
...
![Screenshot der Festlegung des Standardmodus für das Portalmenü](./media/original-preferences/menu-mode.png)
...
![Screenshot mit Azure-Portaleinstellungen mit hervorgehobenen Designs](./media/original-preferences/theme.png)
...
![Screenshot mit Azure-Portaleinstellungen mit hervorgehobenen Popupbenachrichtigungen](./media/original-preferences/pop-up-notifications.png)
...
![Screenshot, der die globale Kopfzeile des Azure-Portals mit hervorgehobenen Benachrichtigungen zeigt](./media/original-preferences/read-notifications.png)
...
![Screenshot der Portaleinstellungen mit hervorgehobenen Timeouteinstellungen bei Inaktivität](./media/original-preferences/inactive-sign-out-user.png)
...
![Screenshot, der Portaleinstellungen mit hervorgehobener Option „Timeoutrichtlinie bei Verzeichnisinaktivität außer Kraft setzen“ zeigt](./media/original-preferences/inactive-sign-out-override.png)
...
1. Wählen Sie den Linktext **Timeout auf Verzeichnisebene konfigurieren** aus.
    ...
    ![Screenshot der Portaleinstellungen mit hervorgehobenem Linktext](./media/original-preferences/settings-admin.png)
...
1. Wählen Sie **Übernehmen**.
    ...
    ![Screenshot der Seite zum Festlegen des Inaktivitätstimeouts auf Verzeichnisebene](./media/original-preferences/configure.png)
...
![Screenshot mit Meldung zur erfolgreichen Benachrichtigung für Inaktivitätstimeout auf Verzeichnisebene](./media/original-preferences/confirmation.png)
...
![Screenshot: Wiederherstellen von Standardeinstellungen](./media/original-preferences/useful-links-restore-defaults.png)
...
![Screenshot: Exportieren von Einstellungen](./media/original-preferences/useful-links-export-settings.png)
...
![Screenshot: Löschen von Einstellungen](./media/original-preferences/useful-links-delete-settings.png)
...
Wählen Sie **Anwenden** aus, um Ihre Sprache und die Einstellungen für das regionale Format zu aktualisieren.
   ...
   ![Screenshot mit Einstellungen für Sprache und regionales Format](./media/original-preferences/language.png)
