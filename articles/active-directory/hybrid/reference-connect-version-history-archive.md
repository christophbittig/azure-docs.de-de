...
>[!NOTE] 
> Dieser Artikel enthält Versionsreferenzinformationen zu allen archivierten Versionen (1.5.42.0 und ältere Versionen) von Azure AD.  Informationen zu aktuellen Releases finden Sie unter [Azure AD Connect: Verlauf der Versionsveröffentlichungen](reference-connect-version-history.md).
...
* Unterstützung für die Kennwortsynchronisierung mit [Azure AD-Domänendiensten](https://support.microsoft.com/account-billing/reset-your-work-or-school-password-using-security-info-23dde81f-08bb-4776-ba72-e6b72b9dda9e)
