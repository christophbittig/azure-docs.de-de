...
> * [Einmaliges Anmelden](./sigma-computing-tutorial.md) bei Sigma Computing (empfohlen)
...
* Eine vorhandene [SSO-Integration](./sigma-computing-tutorial.md) mit Sigma Computing.

## <a name="step-1-plan-your-provisioning-deployment"></a>Schritt 1: Planen der Bereitstellung
1. Erfahren Sie, [wie der Bereitstellungsdienst funktioniert](../app-provisioning/user-provisioning.md).
2. Bestimmen Sie, wer [in den Bereitstellungsbereich](../app-provisioning/define-conditional-rules-for-provisioning-user-accounts.md) einbezogen werden soll.
3. Legen Sie fest, welche Daten [zwischen Azure AD und Sigma Computing zugeordnet werden sollen](../app-provisioning/customize-application-attributes.md). 
...
Fügen Sie Sigma Computing aus dem Azure AD-Anwendungskatalog hinzu, um mit dem Verwalten der Bereitstellung in Sigma Computing zu beginnen. Wenn Sie Sigma Computing zuvor für das einmalige Anmelden (SSO) eingerichtet haben, können Sie dieselbe Anwendung benutzen. Es ist jedoch empfehlenswert, beim erstmaligen Testen der Integration eine separate App zu erstellen. [Hier](../manage-apps/add-application-portal.md) erfahren Sie mehr über das Hinzufügen einer Anwendung aus dem Katalog. 
