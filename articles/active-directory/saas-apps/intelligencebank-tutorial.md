...
## <a name="add-intelligencebank-from-the-gallery"></a>Hinzufügen von IntelligenceBank aus dem Katalog
...
## <a name="configure-and-test-azure-ad-sso-for-intelligencebank"></a>Konfigurieren und Testen des einmaligen Anmeldens von Azure AD für IntelligenceBank
...
1. Navigieren Sie im Azure-Portal auf der Anwendungsintegrationsseite für **IntelligenceBank** zum Abschnitt **Verwalten**, und wählen Sie **Einmaliges Anmelden** aus.
...
1. Führen Sie im Abschnitt **Grundlegende SAML-Konfiguration** die folgenden Schritte aus:
    ...
    b. Geben Sie im Textfeld **Antwort-URL** eine URL im folgenden Format ein: `https://<SUBDOMAIN>.intelligencebank.com/auth`

    c. Geben Sie im Textfeld **Anmelde-URL** eine URL im folgenden Format ein: `https://<SUBDOMAIN>.intelligencebank.com`.

    > [!NOTE]
    > Hierbei handelt es sich um Beispielwerte. Sie müssen diese Werte mit dem tatsächlichen Bezeichner, der Antwort-URL und Anmelde-URL aktualisieren. Wenden Sie sich an das [Clientsupportteam für IntelligenceBank](mailto:helpdesk@intelligencebank.com), um diese Werte zu erhalten. Sie können sich auch die Muster im Abschnitt **Grundlegende SAML-Konfiguration** im Azure-Portal ansehen.
...
1. Klicken Sie auf **Authenticator** und dann auf **Add New** (Neu hinzufügen).
...
1. Führen Sie die folgenden Schritte aus:
    ...
    ![Screenshot: Felder, in die Sie die Informationen dieses Schritts eingeben](./media/intelligencebank-tutorial/fields.PNG)
...
1. Füllen Sie die erforderlichen Felder gemäß den Anforderungen Ihrer Organisation aus, und klicken Sie auf **Speichern**.
    ...
    ![Screenshot: Seite „Neuen Benutzer hinzufügen“, auf der Sie die Benutzerinformationen eingeben](./media/intelligencebank-tutorial/user.PNG)

## <a name="test-sso"></a>Testen des einmaligen Anmeldens 

In diesem Abschnitt testen Sie die Azure AD-Konfiguration für einmaliges Anmelden mit den folgenden Optionen: 

* Klicken Sie im Azure-Portal auf **Diese Anwendung testen**. Dadurch werden Sie zur Anmelde-URL für IntelligenceBank weitergeleitet, wo Sie den Anmeldeflow initiieren können. 

* Navigieren Sie direkt zur Anmelde-URL für IntelligenceBank, und initiieren Sie den Anmeldeflow.

* Sie können „Meine Apps“ von Microsoft verwenden. Wenn Sie unter „Meine Apps“auf die Kachel „IntelligenceBank“ klicken, werden Sie zur Anmelde-URL für IntelligenceBank weitergeleitet. Weitere Informationen zu „Meine Apps“ finden Sie in [dieser Einführung](../user-help/my-apps-portal-end-user-access.md).
