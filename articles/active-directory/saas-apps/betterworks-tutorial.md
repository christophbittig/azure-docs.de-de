---
title: 'Tutorial: Integration des einmaligen Anmeldens (Single Sign-On, SSO) von Azure AD mit BetterWorks'
...
ms.locfileid: "129811158"
---
# <a name="tutorial-azure-ad-sso-integration-with-betterworks"></a>Tutorial: Integration des einmaligen Anmeldens (Single Sign-On, SSO) von Azure AD mit BetterWorks
...
## <a name="configure-and-test-azure-ad-sso-for-betterworks"></a>Konfigurieren und Testen des einmaligen Anmeldens von Azure AD für BetterWorks
...
Führen Sie die folgenden Schritte aus, um das einmalige Anmelden von Azure AD mit BetterWorks zu konfigurieren und zu testen:
...
1. Navigieren Sie im Azure-Portal auf der Anwendungsintegrationsseite für **BetterWorks** zum Abschnitt **Verwalten**, und wählen Sie **Einmaliges Anmelden** aus.
...
1. Führen Sie im Abschnitt **Grundlegende SAML-Konfiguration** die folgenden Schritte aus, wenn Sie die Anwendung im **IDP-initiierten** Modus konfigurieren möchten:
    ...
    a. Geben Sie im Textfeld **Bezeichner** die URL `https://app.betterworks.com/saml2/metadata/` ein.

    b. Geben Sie im Textfeld **Antwort-URL** die folgende URL ein: `https://app.betterworks.com/saml2/acs/`.

1. Klicken Sie auf **Zusätzliche URLs festlegen**, und führen Sie den folgenden Schritt aus, wenn Sie die Anwendung im **SP-initiierten Modus** konfigurieren möchten:

    Geben Sie im Textfeld **Anmelde-URL** die URL ein: `https://app.betterworks.com`.

   > [!NOTE]
   > Wenn Sie ein Kunde von BetterWorks in der Europäischen Union sind, verwenden Sie `eu.betterworks.com` anstelle von `app.betterworks.com` in diesen URLs als Domänennamen.
...
* Klicken Sie im Azure-Portal auf **Diese Anwendung testen**. Dadurch werden Sie zur Anmelde-URL für BetterWorks weitergeleitet, wo Sie den Anmeldeflow initiieren können.  

* Navigieren Sie direkt zur BetterWorks-Anmelde-URL, und initiieren Sie den Anmeldeflow.

#### <a name="idp-initiated"></a>IDP-initiiert:

* Klicken Sie im Azure-Portal auf **Diese Anwendung testen**. Dadurch sollten Sie automatisch bei der BetterWorks-Instanz angemeldet werden, für die Sie einmaliges Anmelden eingerichtet haben. 

Sie können auch den Microsoft-Bereich „Meine Apps“ verwenden, um die Anwendung in einem beliebigen Modus zu testen. Beim Klicken auf die Kachel „BetterWorks“ unter „Meine Apps“ geschieht Folgendes: Wenn Sie die Anwendung im SP-Modus konfiguriert haben, werden Sie zum Initiieren des Anmeldeflows zur Anmeldeseite der Anwendung weitergeleitet. Wenn Sie die Anwendung im IDP-Modus konfiguriert haben, sollten Sie automatisch bei der BetterWorks-Instanz angemeldet werden, für die Sie einmaliges Anmelden eingerichtet haben. Weitere Informationen zu „Meine Apps“ finden Sie in [dieser Einführung](../user-help/my-apps-portal-end-user-access.md).

## <a name="next-steps"></a>Nächste Schritte

Nach dem Konfigurieren von BetterWorks können Sie die Sitzungssteuerung erzwingen, die in Echtzeit vor der Exfiltration und Infiltration vertraulicher Unternehmensdaten schützt. Die Sitzungssteuerung basiert auf bedingtem Zugriff. [Hier](/cloud-app-security/proxy-deployment-aad) erfahren Sie, wie Sie die Sitzungssteuerung mit Microsoft Cloud App Security erzwingen.