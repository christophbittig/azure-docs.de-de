---
title: 'Tutorial: Konfigurieren von Zip für die automatische Benutzerbereitstellung in Azure Active Directory | Microsoft-Dokumentation'
description: Hier erfahren Sie, wie Sie Benutzerkonten aus Azure AD automatisch in Zip bereitstellen und die Bereitstellung wieder aufheben.
...
> * Synchronisieren von Benutzerattributen zwischen Azure AD und Zip
> * Bereitstellen von Gruppen und Gruppenmitgliedschaften in Zip
> * [Einmaliges Anmelden](zip-tutorial.md) bei Zip (empfohlen)
...
### <a name="to-configure-automatic-user-provisioning-for-zip-in-azure-ad"></a>So konfigurieren Sie die automatische Benutzerbereitstellung für Zip in Azure AD:
...
1. Wählen Sie in der Anwendungsliste die Option **Zip** aus.
    ...
    ![Der Zip-Link in der Anwendungsliste](common/all-applications.png)
...
1. Geben Sie im Abschnitt **Administratoranmeldeinformationen** die **Mandanten-URL** und das **geheime Token** für Zip ein. Klicken Sie auf **Verbindung testen**, um sicherzustellen, dass Azure AD eine Verbindung mit Zip herstellen kann. Vergewissern Sie sich im Falle eines Verbindungsfehlers, dass Ihr Zip-Konto über Administratorberechtigungen verfügt, und wiederholen Sie den Vorgang.
...
1. Wählen Sie im Abschnitt **Zuordnungen** die Option **Azure Active Directory-Benutzer mit Zip synchronisieren** aus.
...
1. Um den Azure AD-Bereitstellungsdienst für Zip zu aktivieren, ändern Sie im Abschnitt **Einstellungen** den **Bereitstellungsstatus** in **Ein**.

    ![Aktivierter Bereitstellungsstatus](common/provisioning-toggle-on.png)

1. Legen Sie die Benutzer bzw. Gruppen fest, die in Zip bereitgestellt werden sollen. Wählen Sie dazu im Abschnitt **Einstellungen** unter **Bereich** die gewünschten Werte aus.
