...
- [Interaktiv](scenario-desktop-acquire-token-interactive.md)
- [Integrierte Windows-Authentifizierung](scenario-desktop-acquire-token-integrated-windows-authentication.md)
- [WAM](scenario-desktop-acquire-token-wam.md)
- [Benutzernamenkennwort (Username Password)](scenario-desktop-acquire-token-username-password.md)
- [Gerätecodeflow](scenario-desktop-acquire-token-device-code-flow.md)
