...
>
> > [Schnellstart: Anmelden von Benutzer*innen in Single-Page-Webanwendungen (SPA) mithilfe des Authentifizierungscodeflows](single-page-app-quickstart.md?pivots=devlang-javascript)
> 
