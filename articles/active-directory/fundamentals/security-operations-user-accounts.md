...
Die Protokolldateien für Untersuchung und Überwachung sind wie folgt: 
...
| Ermitteln Sie privilegierte Konten, die nicht für MFA registriert sind.| Hoch| Azure Graph-API| Abfrage von IsMFARegistered ist für Administratorkonten FALSE. <br>[Auflisten von credentialUserRegistrationDetails_ Microsoft Graph-Betaversion | Microsoft-Dokumentation](/graph/api/reportroot-list-credentialuserregistrationdetails?view=graph-rest-beta&tabs=http)| Überwachen und untersuchen Sie, um zu ermitteln, ob Absicht oder ein Versehen vorliegt. |
