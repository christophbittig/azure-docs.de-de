...
| Die Einstellung für Überwachungswarnungen wurde geändert. | Hoch | Azure AD-Überwachungsprotokolle | Dienst = PIM<br>- und -<br>Kategorie = Rollenverwaltung<br>- und -<br>Aktivität = PIM-Warnung deaktivieren<br>- und -<br>Status = Erfolg | Bei unerwarteten Änderungen an einer wichtigen Warnung sollte eine Warnmeldung ausgegeben werden. |
...
| Warnung bei Änderungen an Berechtigungen privilegierter Konten.| Hoch| Azure AD-Überwachungsprotokolle| Kategorie = Rollenverwaltung<br>- und -<br>Aktivitätstyp – Berechtigtes Mitglied hinzufügen (dauerhaft)<br>- und -<br>Aktivitätstyp – Berechtigtes Mitglied hinzufügen (berechtigt)<br>- und -<br>Status = Erfolg/Fehler<br>- und -<br>Geänderte Eigenschaften = Role.DisplayName| Dies gilt insbesondere für Konten, denen Rollen zugewiesen werden, die nicht bekannt sind oder außerhalb ihrer normalen Zuständigkeiten liegen. |
...
Weitere Informationen zum Ermitteln nicht verwendeter privilegierter Konten finden Sie unter [Erstellen einer Zugriffsüberprüfung für Azure AD-Rollen in Privileged Identity Management](../privileged-identity-management/pim-how-to-start-security-review.md).
