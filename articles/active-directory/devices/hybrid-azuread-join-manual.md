...
2. Informationen zum Lokalisieren eines Geräts finden Sie unter [Verwalten von Geräteidentitäten mit dem Azure-Portal](./device-management-azure-portal.md).
