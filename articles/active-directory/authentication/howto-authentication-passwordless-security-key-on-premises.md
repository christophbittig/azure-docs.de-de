...
> [!NOTE]
> Wenn Ihre Organisation die kennwortbasierte Anmeldung schützt und moderne Authentifizierungsmethoden wie MFA, FIDO2 oder Smartcard erzwingt, müssen Sie den Parameter „-UserPrincipalName“ mit dem Benutzerprinzipalnamen eines globalen Administrators verwenden.
>    - Ersetzen Sie `contoso.corp.com` im folgenden Beispiel durch den Namen Ihrer lokalen Active Directory-Domäne.
>    - Ersetzen Sie `administrator@contoso.onmicrosoft.com` im folgenden Beispiel durch den Benutzerprinzipalnamen eines globalen Administrators.
