...
1.  DR-Drill-Gesamtdauer eines Jahres = Anzahl von DR-Drills x einzelne DR-Drill-Dauer (Tage)

2.  Durchschnittliche DR-Drill-Kosten (pro Monat) = DR-Drill-Kosten/12
