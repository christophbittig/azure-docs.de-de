---
title: Behandeln von Problemen mit erweiterten Diagnoseabfragen (SQL-API)
titleSuffix: Azure Cosmos DB
description: Erfahren Sie, wie Sie mithilfe der SQL-API Diagnoseprotokolle für die Problembehandlung von Daten abfragen, die in Azure Cosmos DB gespeichert sind.
author: StefArroyo
services: cosmos-db
...
ms.locfileid: "123097772"
---
# <a name="troubleshoot-issues-with-advanced-diagnostics-queries-for-the-sql-core-api"></a>Behandeln von Problemen mit erweiterten Diagnoseabfragen für die SQL-API (Core-API)
...
### <a name="top-n10-queries-ordered-by-request-unit-ru-consumption-in-a-specific-time-frame"></a>Die wichtigsten N(10)-Abfragen, sortiert nach Verbrauch von Anforderungseinheiten in einem bestimmten Zeitrahmen
...
### <a name="queries-with-the-largest-response-lengths-payload-size-of-the-server-response"></a>Abfragen mit längster Antwort (Nutzdatengröße der Serverantwort)
