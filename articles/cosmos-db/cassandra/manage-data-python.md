...
1. Verwenden Sie die Schaltfläche :::image type="icon" source="./media/manage-data-python/copy.png"::: auf der rechten Seite des Bildschirms, um den obersten Wert (den Kontaktpunkt) zu kopieren. 

   :::image type="content" source="./media/manage-data-python/keys.png" alt-text="Anzeigen und Kopieren eines Benutzernamens, Kennworts und Kontaktpunkts für den Zugriff im Azure-Portal auf dem Blatt „Verbindungszeichenfolge“":::
...
3. Überprüfen Sie die Ergebnisse über die Befehlszeile.
    ...
    :::image type="content" source="./media/manage-data-python/output.png" alt-text="Anzeigen und Überprüfen der Ausgabe":::
    
4. Öffnen Sie im Azure-Portal den **Daten-Explorer**, um diese neuen Daten abzufragen, zu ändern und zu verwenden. 

    :::image type="content" source="./media/manage-data-python/data-explorer.png" alt-text="Anzeigen der Daten im Daten-Explorer":::
