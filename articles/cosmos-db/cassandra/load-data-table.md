...
* Dieser Artikel gehört zu einem mehrteiligen Tutorial. Bevor Sie mit diesem Dokument beginnen, müssen Sie [Cassandra-API-Konto, Keyspace und Tabelle erstellen](create-account-java.md).   
...
> [Abfragen von Daten aus dem Cassandra-API-Konto](query-data.md)
