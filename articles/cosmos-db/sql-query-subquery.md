...
In diesem Artikel werden SQL-Unterabfragen und ihre gängigen Anwendungsfälle in Azure Cosmos DB beschrieben. Alle Beispielabfragen in dieser Dokumentation können für ein [Beispieldataset zu Nährwerten](https://github.com/AzureCosmosDB/labs/blob/master/dotnet/setup/NutritionData.json) ausgeführt werden.
