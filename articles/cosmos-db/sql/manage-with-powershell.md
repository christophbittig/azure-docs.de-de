...
In der folgenden Anleitung erfahren Sie, wie Sie PowerShell-Skripts verwenden und die Verwaltung von Ressourcen für die Core-API (SQL) von Azure Cosmos DB (einschließlich Cosmos-Konten, Datenbanken, Container und Durchsatz) automatisieren. PowerShell-Cmdlets für andere APIs finden Sie unter [Azure PowerShell-Beispiele für Azure Cosmos DB: Cassandra-API](../cassandra/powershell-samples.md), [Azure PowerShell-Beispiele für Azure Cosmos DB: MongoDB-API](../mongodb/powershell-samples.md), [Azure PowerShell-Beispiele für Azure Cosmos DB: Gremlin-API](../graph/powershell-samples.md) und [Azure PowerShell-Beispiele für Azure Cosmos DB: Tabellen-API](../table/powershell-samples.md).
