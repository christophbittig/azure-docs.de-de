...
> [!NOTE]
> In Azure Cosmos DB sind Joins auf ein einzelnes Element beschränkt. Element- und containerübergreifende Joins werden nicht unterstützt. In NoSQL-Datenbanken wie Azure Cosmos DB kann eine sorgfältige [Datenmodellierung](../modeling-data.md) dazu beitragen, dass keine element- und containerübergreifenden Joins erforderlich sind.
