...
PowerShell-Cmdlets für andere APIs finden Sie unter [Azure PowerShell-Beispiele für Azure Cosmos DB: Cassandra-API](../cassandra/powershell-samples.md), [Azure PowerShell-Beispiele für Azure Cosmos DB: MongoDB-API](../mongodb/powershell-samples.md), [Azure PowerShell-Beispiele für Azure Cosmos DB: Gremlin-API](../graph/powershell-samples.md) und [Azure PowerShell-Beispiele für Azure Cosmos DB: Tabellen-API](../table/powershell-samples.md).
