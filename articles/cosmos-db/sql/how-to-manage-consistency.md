...
> [!TIP]
> Konsistenz kann nur auf der Ebene der SDK-Instanz oder der Anforderung **gelockert** werden. Aktualisieren Sie die Standardkonsistenz für das Cosmos-Konto, um von einer schwächeren zu einer stärkeren Konsistenz zu gelangen.
