...
| 408 | Ja | [Timeout bei der Anforderung](troubleshoot-request-timeout-java-sdk-v4-sql.md) |
...
| 429 | Ja | Bei einem Fehler vom Typ 429 kann der Vorgang sicher wiederholt werden. Sie können diesen Fehler vermeiden, indem Sie dem Link für [Zu viele Anforderungen](troubleshoot-request-rate-too-large.md) folgen.|
...
| 503 | Ja | [Dienst nicht verfügbar](troubleshoot-service-unavailable-java-sdk-v4-sql.md) |
