...
1. [Erstellen Sie ein neues Azure Cosmos-Konto](create-table-dotnet.md#1---create-an-azure-cosmos-db-account), oder wählen Sie ein bereits vorhandenes Konto aus.
