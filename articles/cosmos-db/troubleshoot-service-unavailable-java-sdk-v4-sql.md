...
Die folgende Ausnahme wird ausgelöst, wenn das SDK nicht mit der Cosmos DB-Instanz kommunizieren kann. Dies weist normalerweise darauf hin, dass die Anforderungen durch ein Sicherheitsprotokoll, z. B. eine Firewallregel, blockiert werden.
