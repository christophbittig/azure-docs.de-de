...
> [!NOTE]
> In Azure Cosmos DB sind Verknüpfungen auf ein einzelnes Element beschränkt. Element- und containerübergreifende Verknüpfungen werden nicht unterstützt. In NoSQL-Datenbanken wie Azure Cosmos DB kann eine gute [Datenmodellierung](modeling-data.md) dazu beitragen, dass keine element- und containerübergreifenden Verknüpfungen erforderlich sind.
