...
In diesen Beispielen wird ein [Dataset zu Nährwerten](https://github.com/AzureCosmosDB/labs/blob/master/dotnet/setup/NutritionData.json) verwendet.

Hier ist eine Abfrage, die die Gesamtzahl der Artikel in jeder Lebensmittelgruppe zurückgibt:
