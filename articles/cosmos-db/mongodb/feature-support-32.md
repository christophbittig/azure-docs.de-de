...
Die Azure Cosmos DB-API für MongoDB bietet für qualifizierte Konten zudem eine nahtlose Upgradeerfahrung. Weitere Informationen finden Sie im [Upgradehandbuch für MongoDB](upgrade-mongodb-version.md).
