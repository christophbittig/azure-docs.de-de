...
1. Öffnen Sie in Visual Studio Code die Dateien **routes.js** und **hero.service.js** mit der Schaltfläche **Editor teilen** :::image type="icon" source="./media/tutorial-develop-nodejs-part-6/split-editor-button.png":::.
