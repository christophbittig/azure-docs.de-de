...
Teil 2 des Tutorials baut auf der [Einführung](tutorial-develop-nodejs-part-1.md) auf und umfasst folgende Aufgaben:
...
Für diesen Teil des Tutorials wird vorausgesetzt, dass Sie sich das [Einführungsvideo](tutorial-develop-nodejs-part-1.md) angesehen haben.
...
8. Klicken Sie in Visual Studio Code auf die Schaltfläche **Debuggen** :::image type="icon" source="./media/tutorial-develop-nodejs-part-2/debug-button.png"::: und auf die Zahnradschaltfläche :::image type="icon" source="./media/tutorial-develop-nodejs-part-2/gear-button.png":::. Die neue Datei „launch.json“ wird in Visual Studio Code geöffnet. 
...
9. Klicken Sie auf die Schaltfläche **Debuggen starten** :::image type="icon" source="./media/tutorial-develop-nodejs-part-2/start-debugging-button.png":::, um die App auszuführen.
...
2. Klicken Sie auf die Schaltfläche **Senden**, und rufen Sie die JSON-Antwort aus der App ab. 
    ...
    :::image type="content" source="./media/tutorial-develop-nodejs-part-2/azure-cosmos-db-postman.png" alt-text="Postman mit der Anforderung und der Antwort":::
