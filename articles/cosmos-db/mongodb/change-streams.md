...
## <a name="scaling-change-streams"></a>Skalieren von Änderungsdatenströmen
Wenn Sie Änderungsdatenströme im großen Stil verwenden, ist es am besten, die Last gleichmäßig zu verteilen. Verwenden Sie den [benutzerdefinierten Befehl „GetChangeStreamTokens“](../mongodb/custom-commands.md), um die Last auf physische Shards/Partitionen zu verteilen.
