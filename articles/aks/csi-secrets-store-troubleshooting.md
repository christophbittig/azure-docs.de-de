...
Dies bedeutet, dass der Anbieterpod nicht auf die AKV-Instanz zugreifen kann, da
...
- Die Anbieterpods werden auf hostNetwork ausgeführt. Wenn also eine Richtlinie diesen Datenverkehr blockiert oder Netzwerk-Jitter auf dem Knoten vorhanden sind, kann dies zu obigem Fehler führen. Überprüfen Sie, ob Richtlinien konfiguriert sind, um Datenverkehr zu blockieren und Anbieterpods zuzulassen. Stellen Sie außerdem sicher, dass über den Knoten eine Verbindung mit AAD und dem Schlüsseltresor besteht.

Sie können Azure Key Vault Konnektivität von Pods, die im Hostnetzwerk ausgeführt werden, wie folgt testen:
