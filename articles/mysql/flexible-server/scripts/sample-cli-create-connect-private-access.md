---
title: 'CLI-Skript: Erstellen einer Instanz von Azure Database for MySQL – Flexible Server (Vorschau) in einem VNet'
...
ms.locfileid: "128604629"
---
# <a name="create-an-azure-database-for-mysql---flexible-server-preview-in-a-vnet-using-azure-cli"></a>Erstellen einer Instanz von Azure Database for MySQL – Flexible Server (Vorschau) in einem VNet mithilfe der Azure CLI
