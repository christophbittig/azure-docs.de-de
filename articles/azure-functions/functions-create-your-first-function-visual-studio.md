...
> [!NOTE]
> Derzeit befindet sich Azure Functions 4.0 in der Vorschau, und Visual Studio unterstützt das Erstellen von C#-Funktionen, die nur unter .NET 6 mithilfe des [prozessinternen Ausführungsmodells](functions-dotnet-class-library.md) ausgeführt werden.
::: zone-end
...
::: zone-end
::: zone pivot="programming-runtime-functions-v4"
+ [Visual Studio 2022, Vorschau 3 oder höher](https://azure.microsoft.com/downloads/). Wählen Sie bei der Installation unbedingt die Workload **Azure-Entwicklung** aus. 
::: zone-end
