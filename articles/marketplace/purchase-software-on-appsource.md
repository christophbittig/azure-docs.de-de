...
description: Hier werden die Schritte zum Kaufen von Software in Microsoft AppSource (Azure Marketplace) erläutert.
...
ms.locfileid: "112574996"
---
# <a name="purchase-software-on-microsoft-appsource"></a>Kaufen von Software in Microsoft AppSource
...
## <a name="configure-software-post-purchase"></a>Konfigurieren von Software nach dem Kauf
...
Sollten Sie Unterstützung benötigen, können Sie über das Microsoft 365 Admin Center ein [Supportticket](https://admin.microsoft.com/Adminportal/Home?source=applauncher#/homepage) übermitteln.

Nutzen Sie bei Unternehmensprodukten die [Hilfe](/office365/admin/contact-support-for-business-products?tabs=phone).
