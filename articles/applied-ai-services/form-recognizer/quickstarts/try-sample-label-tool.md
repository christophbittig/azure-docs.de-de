...
Extrahieren Sie Text, Tabellen und Schlüssel-Wert-Paare aus Rechnungen, Verkaufsbelegen, Ausweisdokumenten oder Visitenkarten mithilfe eines vordefinierten Modells für die Formularerkennung.
...
4. Wählen Sie aus den folgenden Optionen die Datei aus, die Sie analysieren möchten:
    ...
    * Eine URL für ein Bild eines Ausweisdokuments. Für diese Schnellstartanleitung können Sie ein [Dokument einer Beispiel-ID](https://raw.githubusercontent.com/Azure-Samples/cognitive-services-REST-api-samples/master/curl/form-recognizer/DriverLicense.png) verwenden.
