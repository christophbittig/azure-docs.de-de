...
1. Wählen Sie im Menü **Defender für Cloud** die Option **Sicherheitsrichtlinie** aus.
...
1. Wählen Sie im Menü von Defender für Cloud die Option **Sicherheitsrichtlinie** aus.
    ...
    :::image type="content" source="./media/tutorial-security-policy/policy-management.png" alt-text="Starten des Prozesses zur Richtlinienverwaltung in Microsoft Defender für Cloud":::
