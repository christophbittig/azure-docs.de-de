---
title: Schützen Ihrer Netzwerkressourcen in Microsoft Defender für Cloud
description: Dieses Dokument behandelt Empfehlungen in Microsoft Defender für Cloud, die zum Schutz Ihrer Azure-Netzwerkressourcen sowie zur Einhaltung von Sicherheitsrichtlinien beitragen.
author: memildin
manager: rkarlin
...
Dieser Artikel behandelt Empfehlungen, die aus Sicht der Netzwerksicherheit auf Ihre Azure-Ressourcen zutreffen. Bei Netzwerkempfehlungen stehen Firewalls der nächsten Generation, Netzwerksicherheitsgruppen, Regeln für den eingehenden Datenverkehr mit übermäßigem JIT-VM-Zugriff und vieles mehr im Mittelpunkt. Eine Liste von Netzwerkempfehlungen und Aktionen zur Problembehebung finden Sie unter [Verwalten von Sicherheitsempfehlungen in Microsoft Defender für Cloud](review-security-recommendations.md).

Das Feature **Netzwerk** von Defender für Cloud umfasst Folgendes: 

- Netzwerkübersicht (erfordert Microsoft Defender für Server)
- [Adaptive Netzwerkhärtung](adaptive-network-hardening.md) (erfordert Microsoft Defender für Server)
...
:::image type="content" source="./media/protect-network-resources/network-filters-inventory.png" alt-text="Netzwerk-Ressourcentypen im Ressourcenbestand" lightbox="./media/protect-network-resources/network-filters-inventory.png":::
...
1. Öffnen Sie im Menü von Defender für Cloud das Dashboard **Workloadschutz**.

1. Wählen Sie **Netzwerkübersicht** aus.

    :::image type="content" source="./media/protect-network-resources/opening-network-map.png" alt-text="Öffnen der Netzwerkübersicht über „Workloadschutz“" lightbox="./media/protect-network-resources/opening-network-map.png":::

1. Wählen Sie im Menü **Schichten** die Option **Topologie** aus.
 
Die Standardansicht der Topologie umfasst Folgendes:

- Derzeit ausgewählte Abonnements. Die Übersicht ist für die Abonnements optimiert, die Sie im Portal ausgewählt haben. Wenn Sie die Auswahl ändern, wird die Übersicht entsprechend der neuen Auswahl neu generiert.
...
- VNets mit Peering
- Nur Ressourcen, die [Netzwerkempfehlungen](review-security-recommendations.md) mit einem hohen oder mittleren Schweregrad aufweisen.
- Ressourcen mit Internetzugriff.

:::image type="content" source="./media/protect-network-resources/network-map-info.png" alt-text="Screenshot der Übersicht über die Netzwerktopologie in Defender für Cloud" lightbox="./media/protect-network-resources/network-map-info.png":::
...
- Verwenden Sie die Indikatoren für den Schweregrad, um schnell einen Überblick über die Ressourcen zu erhalten, für die offene Empfehlungen aus Defender für Cloud vorhanden sind.
...
- Wenn zu viele Ressourcen in der Übersicht angezeigt werden, verwendet Microsoft Defender für Cloud einen eigenen Algorithmus zum intelligenten Gruppieren Ihrer Ressourcen und hebt diejenigen hervor, die den kritischsten Zustand und die meisten Empfehlungen mit höchstem Schweregrad aufweisen.
...
1. Sie können die Anzeige in der Netzwerkübersicht mithilfe der Filter am oberen Rand ändern. Sie können als Schwerpunkt der Übersicht Folgendes festlegen:
   ...
   - **Empfehlungen**: Sie können die Anzeige von Ressourcen basierend auf den Empfehlungen auswählen, die für diese Ressourcen aktiv sind. Sie können beispielsweise nur Ressourcen anzeigen, für die Defender für Cloud das Aktivieren von Netzwerksicherheitsgruppen empfiehlt.
...
[![Übersicht über den Netzwerkdatenverkehr](./media/protect-network-resources/network-map-traffic.png)](./media/protect-network-resources/network-map-traffic.png#lightbox)
...
- [Schützen von Computern und Anwendungen in Microsoft Defender für Cloud](./asset-inventory.md)
