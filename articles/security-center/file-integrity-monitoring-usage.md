---
title: Überwachung der Datenintegrität in Microsoft Azure Defender Center
description: Erfahren Sie, wie Sie Baselines mit der Überwachung der Datenintegrität in Microsoft Azure Defender vergleichen.
...
In diesem Thema wird erläutert, wie Sie FIM für die Dateien und Registrierungen aktivieren. Weitere Informationen zu FIM finden Sie unter [Überwachung der Datenintegrität in Microsoft Azure Defender](file-integrity-monitoring-overview.md).
...
![Registrierung.](./media/file-integrity-monitoring-usage/baselines-registry.png)
...
1. Geben Sie im Fenster **Windows-Registrierung für Änderungsnachverfolgung hinzufügen** im Textfeld **Windows-Registrierungsschlüssel** den folgenden Registrierungsschlüssel ein:
    ...
    :::image type="content" source="./media/file-integrity-monitoring-usage/baselines-add-registry.png" alt-text="Aktivieren von FIM für eine Registrierung":::
...
1. Erstellen Sie einen benutzerdefinierten Windows-Dateieintrag, indem Sie einen Namen der Einstellungsklasse angeben, die Rekursion aktivieren und den obersten Ordner mit einem Platzhaltersuffix (*) angeben.
    ...
    :::image type="content" source="./media/file-integrity-monitoring-usage/baselines-add-file.png" alt-text="Aktivieren von FIM für eine Datei":::
...
![FIM-Daten](./media/file-integrity-monitoring-usage/baselines-data.png)