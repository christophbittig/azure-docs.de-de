...
|Geschützte SQL-Versionen:|SQL Server (derzeit [von Microsoft unterstützte](/mem/configmgr/core/plan-design/configs/support-for-sql-server-versions) Versionen)|
...
- **SQL Server auf Servern mit Azure Arc-Unterstützung**: Installieren Sie den Azure Arc-Agent anhand der Installationsmethoden, die in der [Azure Arc-Dokumentation](../azure-arc/servers/manage-vm-extensions.md) beschrieben sind.
