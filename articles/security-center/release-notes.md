...
- [Dem MITRE ATT-&amp;CK®-Framework zugeordnete Empfehlungen – jetzt allgemein verfügbar](#recommendations-mapped-to-the-mitre-attck-framework---released-for-general-availability-ga)
...
### <a name="recommendations-mapped-to-the-mitre-attck-framework---released-for-general-availability-ga"></a>Dem MITRE ATT-&amp;CK®-Framework zugeordnete Empfehlungen – jetzt allgemein verfügbar
...
- **Die Seite „Empfehlungen“ in Defender für Cloud** verfügt über einen neuen :::image type="icon" source="media/review-security-recommendations/tactics-filter-recommendations-page.png" border="false":::-Filter zur Auswahl von Empfehlungen nach der zugehörigen Taktik:

Weitere Informationen finden Sie unter [Überprüfen der Sicherheitsempfehlungen](review-security-recommendations.md).
