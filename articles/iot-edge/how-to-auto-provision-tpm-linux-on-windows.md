...
Informationen zum Erstellen einer individuellen Registrierung für ein simuliertes TPM-Gerät finden Sie im [Schnellstart: Bereitstellen eines simulierten TPM-Geräts](../iot-dps/quick-create-simulated-device-tpm.md).
