...
> [Bing Entity Search API reference (Referenzdokumentation zur Bing-Entitätssuche-API)](/rest/api/cognitiveservices/bing-entities-api-v7-reference)

> [!div class="nextstepaction"]
> [Bing Maps API documentation (Dokumentation zur Bing Karten-API)](/bingmaps/)