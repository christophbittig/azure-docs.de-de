...
In diesem Beispiel wird das [PiggyMetrics](https://github.com/Azure-Samples/piggymetrics)-Beispiel auf GitHub verwendet.  Forken Sie das Beispiel, öffnen Sie die GitHub-Repositoryseite, und wählen Sie die Registerkarte **Einstellungen** aus. Öffnen Sie das Menü **Geheimnisse**, und wählen Sie **Neues Geheimnis hinzufügen** aus:
