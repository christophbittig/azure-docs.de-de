...
Im Rahmen dieses Artikels haben Sie einen Load Balancer Standard-Lastenausgleich mit einer dualen Front-End-IP-Konfiguration (IPv4 und IPv6) erstellt. Sie haben außerdem zwei virtuelle Computer mit NICs mit dualen IP-Konfigurationen (IPV4 und IPv6) erstellt, die dem Back-End-Pool des Load Balancers hinzugefügt wurden. Um mehr über Support von IPv6 in Azure Virtual Network zu erfahren, siehe [Was ist IPv6 für Azure Virtual Network?]((../virtual-network/ip-services/ipv6-overview.md)
