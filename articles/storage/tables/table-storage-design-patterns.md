...
![Grafik einer Mitarbeiterentität: Eine Clientanwendung kann eine Punktabfrage verwenden, um eine einzelne Mitarbeiterentität mithilfe des Abteilungsnamens und der Mitarbeiter-ID abzurufen (Werte PartitionKey und RowKey)](media/storage-table-design-guide/storage-table-design-IMAGE06.png)
...
![Grafische Darstellung einer Mitarbeiterentität mit unterschiedlichen RowKey-Werten](media/storage-table-design-guide/storage-table-design-IMAGE07.png)
...
* Sie müssen nicht unbedingt alle Eigenschaften der Entität duplizieren. Beispiel: Wenn die Abfragen, mit denen die Entitäten anhand der E-Mail-Adresse in **RowKey** gesucht werden, nie das Alter des Mitarbeiters benötigen, könnten diese Entitäten die folgende Struktur aufweisen:
   ...
   ![Grafische Darstellung der Mitarbeiterentität](media/storage-table-design-guide/storage-table-design-IMAGE08.png)
...
![Grafik einer Mitarbeiterentitätsstruktur: Eine Clientanwendung kann eine Punktabfrage verwenden, um mithilfe des Abteilungsnamens und der Mitarbeiter-ID (Werte „PartitionKey“ und „RowKey“) eine einzelne Mitarbeiterentität abzurufen.](media/storage-table-design-guide/storage-table-design-IMAGE09.png)
...
![Grafische Darstellung einer Mitarbeiterentität mit primärem Index und einer Mitarbeiterentität mit sekundärem Index](media/storage-table-design-guide/storage-table-design-IMAGE10.png)
...
* Sie müssen nicht unbedingt alle Eigenschaften der Entität duplizieren. Beispiel: Wenn die Abfragen, mit denen die Entitäten anhand der E-Mail-Adresse in **RowKey** gesucht werden, nie das Alter des Mitarbeiters benötigen, könnten diese Entitäten die folgende Struktur aufweisen:
   ...
   ![Grafische Darstellung einer Mitarbeiterentität mit sekundärem Index](media/storage-table-design-guide/storage-table-design-IMAGE11.png)
...
![Lösungsdiagramm für letztendliche Konsistenz](media/storage-table-design-guide/storage-table-design-IMAGE12.png)
...
![Grafik einer Mitarbeiterentitätsstruktur: Eine Clientanwendung kann eine einzelne Mitarbeiterentität mithilfe des Abteilungsnamens und der Mitarbeiter-ID effizient abrufen (PartitionKey und RowKey).](media/storage-table-design-guide/storage-table-design-IMAGE13.png)
...
![Grafische Darstellung einer Mitarbeiterentität mit einer Zeichenfolge, die eine Liste der Mitarbeiter-IDs mit demselben Nachnamen enthält](media/storage-table-design-guide/storage-table-design-IMAGE14.png)
...
![Grafische Darstellung der Abteilungsentität und Mitarbeiterentität](media/storage-table-design-guide/storage-table-design-IMAGE16.png)
...
![Grafische Darstellung der denormalisierten und kombinierten Abteilungsentität](media/storage-table-design-guide/storage-table-design-IMAGE17.png)
...
![Grafik der Mitarbeiterentitätsstruktur, die Sie zum Speichern von Mitarbeiterentitäten im Tabellenspeicher verwenden sollten](media/storage-table-design-guide/storage-table-design-IMAGE18.png)
...
![Grafische Darstellung der Entität für Mitarbeiterüberprüfung](media/storage-table-design-guide/storage-table-design-IMAGE19.png)
...
![Grafische Darstellung einer Mitarbeiterentität mit zusammengesetztem Schlüssel](media/storage-table-design-guide/storage-table-design-IMAGE20.png)
...
![Grafische Darstellung der Entität für Anmeldeversuch](media/storage-table-design-guide/storage-table-design-IMAGE21.png)
...
![Grafische Darstellung der Entität für Nachrichtenstatistik](media/storage-table-design-guide/storage-table-design-IMAGE22.png)
...
![Grafische Darstellung der Entität für Nachrichtenstatistik mit separaten Eigenschaften](media/storage-table-design-guide/storage-table-design-IMAGE23.png)
...
![Grafische Darstellung der Entität für Nachrichtenstatistik mit Rowkey 01 und Entität für Nachrichtenstatus mit Rowkey 02](media/storage-table-design-guide/storage-table-design-IMAGE24.png)
...
![Grafische Darstellung der Mitarbeiterentität mit einer Zeichenfolge für das Foto, das auf den Blobspeicher verweist](media/storage-table-design-guide/storage-table-design-IMAGE25.png)
...
Wenn Sie die Tabellenclientbibliothek verwenden, kann diese automatisch Fortsetzungstoken für Sie verarbeiten, da sie Entitäten aus dem Tabellenspeicherdienst zurückgibt. Das folgende C#-Codebeispiel verwendet die Tabellenclientbibliothek und verarbeitet Fortsetzungstoken automatisch, wenn diese vom Tabellenspeicherdienst in einer Antwort zurückgegeben werden:  
