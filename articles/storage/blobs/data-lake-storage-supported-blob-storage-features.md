...
|Vom Kunden verwaltete Schlüssel|Allgemein verfügbar|Allgemein verfügbar|[Kundenseitig verwaltete Schlüssel für die Azure Storage-Verschlüsselung](../common/customer-managed-keys-overview.md?toc=/azure/storage/blobs/toc.json)|
...
|Vorläufiges Löschen von Containern|Allgemein verfügbar|Allgemein verfügbar|[Vorläufiges Löschen für Container](soft-delete-container-overview.md)|
...
|Statische Websites|Allgemein verfügbar<div role="complementary" aria-labelledby="preview-form"></div>|Allgemein verfügbar<div role="complementary" aria-labelledby="preview-form"></div>|[Hosten von statischen Websites in Azure Storage](storage-blob-static-website.md)|
|Unveränderlicher Speicher|Vorschau<div role="complementary" aria-labelledby="preview-form"><sup>1</sup></div>|Vorschau<div role="complementary" aria-labelledby="preview-form"><sup>1</sup></div>|[Speichern unternehmenskritischer Blobdaten mit unveränderlichem Speicher](immutable-storage-overview.md)|
...
|Benutzerdefinierte Domänen|Vorschau<div role="complementary" aria-labelledby="preview-form-1"><sup>1</sup></div>|Vorschau<div role="complementary" aria-labelledby="preview-form-1"><sup>1</sup></div>|[Zuordnen einer benutzerdefinierten Domäne zu einem Azure Blob Storage-Endpunkt](storage-custom-domain-name.md)|
|Vorläufiges Löschen von Blobs|Vorschau|Vorschau|[Vorläufiges Löschen für Blobs](./soft-delete-blob-overview.md)|
...
<div id="preview-form-2"><sup>1</sup> Ein benutzerdefinierter Domänenname kann nur dem Blob-Dienstendpunkt oder dem statischen Websiteendpunkt zugeordnet werden. Der Data Lake Storage-Endpunkt wird nicht unterstützt.</a>.  </div>
