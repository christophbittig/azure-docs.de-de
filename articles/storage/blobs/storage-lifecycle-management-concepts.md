...
> [!NOTE]
> Weitere Informationen zum Blobindexfeature sowie zu bekannten Problemen und Einschränkungen finden Sie unter [Verwalten und Finden von Azure-Blobdaten mit Blobindextags (Vorschau)](storage-manage-find-blobs.md).
...
Die Option **Letzter Zugriff** ist in der Vorschau in allen öffentlichen Regionen verfügbar.
