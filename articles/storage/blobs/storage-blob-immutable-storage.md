...
> [!IMPORTANT]
> Unveränderlicher Speicher für Azure-Blobspeicher in Konten, für die das Feature für hierarchische Namespaces aktiviert ist, befindet sich derzeit in der VORSCHAUPHASE.
...
>
>
> Wie Sie sich für die Vorschau registrieren, erfahren Sie in [diesem Formular](https://forms.microsoft.com/Pages/ResponsePage.aspx?id=v4j5cvGGr0GRqy180BHbR2EUNXd_ZNJCq_eDwZGaF5VUOUc3NTNQSUdOTjgzVUlVT1pDTzU4WlRKRy4u).
...
Ja, wenn das vorläufige Löschen in Ihren Konformitätsanforderungen aktiviert werden kann. Das [vorläufige Löschen für Azure-Blobspeicher](./soft-delete-blob-overview.md) gilt für alle Container eines Speicherkontos, unabhängig davon, ob eine Richtlinie für die gesetzliche Aufbewahrungspflicht oder eine zeitbasierte Aufbewahrungsrichtlinie aktiviert ist. Microsoft empfiehlt Ihnen, das vorläufige Löschen als zusätzlichen Schutz zu verwenden, bevor Unveränderlichkeitsrichtlinien angewendet werden. Wenn vorläufiges Löschen für einen Container aktiviert ist und dem Container dann eine Unveränderlichkeitsrichtlinie hinzugefügt wird, werden alle Blobs, die bereits vorläufig gelöscht wurden, dauerhaft gelöscht, sobald die Aufbewahrungsrichtlinie für vorläufiges Löschen abgelaufen ist. Vorläufig gelöschte Blobs können während des Aufbewahrungszeitraums für vorläufiges Löschen wiederhergestellt werden. Blobs, die noch nicht vorläufig gelöscht wurden, werden durch die Unveränderlichkeitsrichtlinie geschützt und können erst vorläufig gelöscht werden, wenn die Unveränderlichkeitsrichtlinie abgelaufen ist (bei zeitbasierter Aufbewahrung) oder entfernt wurde (bei gesetzlicher Aufbewahrungspflicht).
