...
| Ebenen | <ul><li>Premium</li><li>Für Transaktion optimiert</li><li>Hot</li><li>Kalt</li></ul><br> Weitere Informationen finden Sie unter [Speicherebenen](./storage-files-planning.md#storage-tiers). | <ul><li>Ultra</li><li>Premium</li><li>Standard</li></ul><br> Alle Ebenen bieten unter MS eine minimale Wartezeit.<br><br> Weitere Informationen finden Sie unter [Dienstebenen](../../azure-netapp-files/azure-netapp-files-service-levels.md) und [Überlegungen zur Leistung](../../azure-netapp-files/azure-netapp-files-performance-considerations.md). |
