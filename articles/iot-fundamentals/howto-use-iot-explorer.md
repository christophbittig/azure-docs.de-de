...
In diesem Artikel haben Sie erfahren, wie Sie den Azure-IoT-Explorer installieren und verwenden, um mit Ihren IoT Plug & Play-Geräten zu interagieren. Es wird empfohlen, dass Sie sich als Nächstes über das [Verwalten von digitalen IoT Plug & Play-Zwillingen](../iot-develop/howto-manage-digital-twin.md) informieren.
