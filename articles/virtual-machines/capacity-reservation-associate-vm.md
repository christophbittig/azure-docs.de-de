...
Verwenden Sie `az vm create`, um einen neuen virtuellen Computer zu erstellen und die Eigenschaft `capacity-reservation-group` hinzuzufügen, um sie einer vorhandenen Kapazitätsreservierungsgruppe zuzuordnen. Im folgenden Beispiel wird eine Standard_D2s_v3 VM am Standort USA, Osten erstellt und der VM einer Kapazitätsreservierungsgruppe zugeordnet.
